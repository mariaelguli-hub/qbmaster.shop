  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex-1 flex flex-col pt-1">
        ...
        <h3 
          onClick={handleBuyNow}
          className="font-extrabold text-gray-900 mb-2 leading-snug text-base group-hover:text-purple-700 transition-colors cursor-pointer"
        >
          {product.name}
        </h3>
        ...
        >
          <button 
            onClick={handleBuyNow}
            className="w-full relative py-3.5 px-5 bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-700 text-white font-extrabold text-sm tracking-wide flex items-center justify-center gap-2.5 transition-all duration-300"
          >
            {/* Shimmer / Glossy Beam */}
