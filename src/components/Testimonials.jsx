          ...
          {testimonials.map((t, idx) => (
            ...
            >
              ...
              <div>
                ...
                {/* Review Title */}
                <h3 className="font-extrabold text-gray-900 text-base mb-2 group-hover:text-purple-800 transition-colors">
                  {t.title}
                </h3>
              ...
              <div className="flex items-center justify-between gap-3 pt-4 border-t border-gray-100 mt-auto">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-purple-600 to-indigo-800 text-white flex items-center justify-center text-xs font-black shadow-md shadow-purple-900/10 border border-purple-400/30 shrink-0">
                    {t.initials}
                  </div>
                ...
                {t.verified && (
                  <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-purple-50 border border-purple-200/60 text-purple-700 text-[10px] font-black uppercase tracking-wider shrink-0">
                    <BadgeCheck className="w-3.5 h-3.5 text-purple-600 stroke-[2.5]" />
                    <span>Verified</span>
                  </div>
                )}
