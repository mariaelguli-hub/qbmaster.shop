...
import { Truck, ShieldCheck, ArrowRight, Sparkles, CheckCircle2, ShoppingBag } from 'lucide-react'
...
export default function CTASection() {
  ...
  return (
    <section className="relative py-20 lg:py-28 overflow-hidden bg-gradient-to-br from-purple-950 via-indigo-950 to-purple-950 text-white font-sans">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <span>Trusted by thousands of happy homes • 24/7 support</span>
        </motion.div>
        ...
        >
          Upgrade your <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-violet-200 to-indigo-300">Home & Garden</span> today
        </motion.h2>
        ...
        >
          Curated everyday essentials. Insured doorstep delivery. Backed by our 30-day money-back guarantee.
        </motion.p>
        ...
        >
          <span className="flex items-center gap-1.5 bg-white/5 px-3 py-1 rounded-full border border-white/10">
            <CheckCircle2 className="w-4 h-4 text-purple-400" /> Tested Heavy-Duty Quality
          </span>
          <span className="flex items-center gap-1.5 bg-white/5 px-3 py-1 rounded-full border border-white/10">
            <Truck className="w-4 h-4 text-amber-400" /> Fast Insured Doorstep Delivery
          </span>
          <span className="flex items-center gap-1.5 bg-white/5 px-3 py-1 rounded-full border border-white/10">
            <ShieldCheck className="w-4 h-4 text-purple-400" /> 30-Day Money-Back Guarantee
          </span>
        </motion.div>

        {/* ⚡ Glowing White Action Button */}
        <motion.div 
